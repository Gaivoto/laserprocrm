<template>
  <div class="modal fade" id="kt_modal_alter_fornecedor" ref="alterFornecedorModalRef" tabindex="-1" aria-hidden="true" >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <!--begin::Modal content-->
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_alter_fornecedor_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Alterar Fornecedor</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div id="kt_modal_alter_fornecedor_close" data-bs-dismiss="modal" class="btn btn-icon btn-sm btn-active-icon-primary">
        ...
        <el-form :model="formInfo" ref="formRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            <!--begin::Scroll-->
            <div class="scroll-y me-n7 pe-7" id="kt_modal_alter_fornecedor_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
              <!--begin::Input group-->
              ...
              <div class="fv-row mb-8">
                ...
                <el-form-item prop="email">
                  <el-input v-model="formInfo.email" type="email"/>
                </el-form-item>
                <!--end::Input-->
              </div>
              <!--end::Input group-->
              ...
              <div class="fv-row mb-8">
                ...
                <el-form-item prop="contacto">
                  <el-input v-model="formInfo.contacto" type="number"/>
                </el-form-item>
                <!--end::Input-->
              </div>
              <!--end::Input group-->
              ...
              <div class="fv-row mb-8">
                ...
                <el-form-item prop="nif">
                  <el-input v-model="formInfo.nif" type="number"/>
                </el-form-item>
                <!--end::Input-->
              </div>
              <!--end::Input group-->
