<template>
  <div class="modal fade" id="kt_modal_add_adm" ref="addAdmModalRef" tabindex="-1" aria-hidden="true" >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <!--begin::Modal content-->
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_add_adm_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Criar Administrador</h2>
          <!--end::Modal title-->

          <!--begin::Close-->
          <div id="kt_modal_add_adm_close" data-bs-dismiss="modal" class="btn btn-icon btn-sm btn-active-icon-primary">
        ...
        <el-form :model="formInfo" ref="formRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            <!--begin::Scroll-->
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_adm_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
              <!--begin::Input group-->
          ...
          <div class="modal-footer flex-center">
            <!--begin::Button-->
            <button type="reset" id="kt_modal_add_adm_cancel" class="btn btn-light me-3" >
              Limpar
            </button>
            <!--end::Button-->

            <!--begin::Button-->
            <div id="kt_modal_add_adm_cancel" class="btn btn-lg btn-primary" v-on:click="createAdm" >
              Criar
...
export default {
  ...
  methods: {
    ...
    createAdm() {
        ...
        if(this.verifyAdmData()) this.$emit("create-adm", info);
    }
  }
}
</script>
