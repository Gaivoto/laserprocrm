    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content" v-on:click="this.produtosSearchOpen = false; this.materiaisSearchOpen = false; this.tiposSearchOpen = false; this.subtiposSearchOpen = false; this.ligasSearchOpen = false">
        ...
        <div class="modal-header" id="kt_modal_add_material_header">
          <!--begin::Modal title-->
          <h2 class="fw-bold">Criar Material</h2>
          <!--end::Modal title-->
        ...
        <el-form :model="formInfo" ref="formRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            <!--begin::Scroll-->
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_material_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
              <!--begin::Input group-->
          ...
          <div class="modal-footer flex-center">
            ...
            <!--begin::Button-->
            <div id="kt_modal_add_customer_cancel" class="btn btn-lg btn-primary" v-on:click="createMaterial" >
              Criar
